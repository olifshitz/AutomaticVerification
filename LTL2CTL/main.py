...
from ctl.model_checker import CtlModelChecker, ctl
...
notaandnotb = ltl_form.FormConst.f_and(
    ltl_form.FormConst.f_not('a'), ltl_form.FormConst.f_not('b'))
...
test_ctl_formula(
    ctl.formula_parser.FormConst.f_forall_globally(
        ctl.formula_parser.FormConst.f_exists_eventually('b')),
    [1, 2, 3, 4])  # false
test_ctl_formula(
    ctl.formula_parser.FormConst.f_exists_globally(
        ctl.formula_parser.FormConst.f_forall_eventually('b')),
    [1, 2, 3, 4])  # false
test_ctl_formula(
    ctl.formula_parser.FormConst.f_exists_globally(
        ctl.formula_parser.FormConst.f_forall_eventually(notaandnotb)),
    [])  # false
test_ctl_formula(
    ctl.formula_parser.FormConst.f_forall_eventually(notaandnotb),
    [3])  # false
test_ctl_formula(
    ctl.formula_parser.FormConst.f_exists_eventually(notaandnotb),
    [1, 2, 3])  # false
...
test_ltl_formula(
    ltl_form.FormConst.f_not(
        ltl_form.FormConst.f_and(aandb,
                                 ltl_form.FormConst.f_until(aandb, aandnotb))),
    [1, 3, 4], True)
test_ltl_formula(
    ltl_form.FormConst.f_and(aandb, ltl_form.FormConst.f_until(
        aandb, notaandb)), [], True)

test_ltl_formula(ltl_form.FormConst.f_globally('b'), [4], True)
test_ltl_formula(
    ltl_form.FormConst.f_eventually(ltl_form.FormConst.f_not('b')), [1, 2, 3],
    True)
test_ltl_formula(
    ltl_form.FormConst.f_globally(
        ltl_form.FormConst.f_eventually(ltl_form.FormConst.f_not('b'))),
    [1, 2], True)
