...
\section{Experiments and Results}
    ...
    \subsection{Testing the LTL model checker}
        As described in Table \ref{table:1}, the TCL checking computation time is significally longer then the CTL checker. Unfortunately, it
        ...
        The conversion could help though, mostly because it demends much less computation steps - for example, each computation of sat is completed a bit faster,
